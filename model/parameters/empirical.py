...
worm_proportions_empirical = data[['worms', 'id']].groupby('worms').count()/data.shape[0]
...
p = {
    ...
    'min_initial_worm_eating_proportion': 0,
    ...
    # Animal population
    'N_dogs': round(N/6),
    'initial_worms_per_dog': data_animals.loc['dog'].item(),
    'N_cats': round(N/6),
    'initial_worms_per_cat': data_animals.loc['cat'].item(),
    'N_snails': N*100,
    ...
    # Empirical
    'beta_hf_distribution': 'empirical_worms',
    'beta_empirical_worms_a': -2.760,
    'beta_empirical_worms_b': 0.962,
    'log_beta_cf': -.725,
    'log_beta_df': -2.503,
    'log_beta_sx': -9.874,
    'log_beta_fs': -.857,
